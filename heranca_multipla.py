class Relogio:
    ...
    def __str__(self):
        return f"{self.hora:02d}:{self.min:02d}:{self.seg:02d}" + ', ' + super(Relogio, self).__str__()
...
class CalendarioRelogio(Relogio, Calendario): # a ordem dos argumentos faz diferença
